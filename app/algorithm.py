...
def calc_anime_date(uid, anime_id):
    ...
    if current_JST.weekday() == deets['anime_date']: 
        ...
        if difference >= 0 and difference < 30:
            add_anime_algo(uid, "An episode of your favorite anime is about to air in " + str(truncate(difference, 2)) + " minutes.")    
            return difference / 30 
        elif difference < 0 and difference < -60:
            add_anime_algo(uid, "An episode of your favorite anime has aired " + str(truncate(-1 * difference, 2)) + " minutes ago.")
